package com.example.practice_mlkit
...
class MainActivity : AppCompatActivity(), SurfaceTextureListener, MoviePlayer.PlayerFeedback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        videoTextView.surfaceTextureListener = this
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if(resultCode == Activity.RESULT_OK && requestCode == 101){
            if(data?.data!=null){
                ...
                VideoImageView.setImageBitmap(mediaMetadataRetriever.getFrameAtIndex(0))
    ...
    fun clickPlayStop() {
        ...
        val st: SurfaceTexture = videoTextView.getSurfaceTexture()!!
    ...
    private fun adjustAspectRatio(videoWidth: Int, videoHeight: Int) {
        val viewWidth = videoTextView.width
        val viewHeight = videoTextView.height
        ...
        val txform = Matrix()
        videoTextView.getTransform(txform)
        txform.setScale(
        ...
        videoTextView.setTransform(txform)
    }
        ...
        if (bm != null) {
            ...
            poseDetector.process(inputImage)
                .addOnSuccessListener { pose ->
                    if (MainLayout.childCount > 4) MainLayout.removeViewAt(4)
                    VideoImageView.setImageBitmap(bm)
